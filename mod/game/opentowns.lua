...
function initMod ()
    ...
    options4:newBit(text       (1.0,2.0,"This option set the CPU usage for pathfinding (Default value: 2)","0xFFFFFF"))
...
--    options4:newBit(textButton (1.0,3.5 ,"CPU level usage for pathfinding","0xFFFFFF","2"))
    ...
    options5:newBit(textButton (1.0,2.5,"Scroll up","0xFFFFFF","scrollUp"))
    options5:newBit(textButton (1.0,3.0,"Scroll down","0xFFFFFF","scrollDown"))
    options5:newBit(textButton (1.0,3.5,"Scroll left","0xFFFFFF","scrollLeft"))
    options5:newBit(textButton (1.0,4.0,"Scroll right","0xFFFFFF","scrollRight"))
    options5:newBit(textButton (1.0,4.5,"Level up","0xFFFFFF","levelUp"))
    options5:newBit(textButton (1.0,5.0,"Level down","0xFFFFFF","levelDown"))
    ...
    options6:newBit(funcButton (1.0,2.0,"English","0xFFFFFF","espanol"))
